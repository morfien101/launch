...
func TestDefaultConfig(t *testing.T) {
	...
	if cf.Processes.InitProcesses[0].LoggerConfig.Engine[0] != cf.DefaultLoggerConfig.Config.Engine[0] {
...
func TestDefaultConfigNotRequired(t *testing.T) {
	...
	cf.ProcessManager = ProcessManager{
		LoggerConfig: LoggingConfig{
			Engine: pmLogger,
		},
	}
...
func TestConfigString(t *testing.T) {
	...
	//lint:igonre S1025 this tests the ToString function that is used when fmt converts a struct.
	if fmt.Sprintf("%s", cf) == "" {
